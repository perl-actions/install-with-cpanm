...
Releases are performed by the same long-standing maintainers as always. The release process — including changelog review, version tagging, and publication — is handled through GitHub's release workflow. Every release is initiated, supervised, and published by a human maintainer.
